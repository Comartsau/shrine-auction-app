  ...
  return (
    <div className=" flex flex-col  bg-gray-200 h-screen m-0  ">
      ...
      <div className="flex  items-center justify-between item-center text-white bg-red-400 px-5 py-[20px] sm:py-[20px] md:py-[22px] lg:py-[22px] xl:py-[23px] ">
        ...
        <div className="flex w-[50%] md:w-[30%] lg:w-[25%] xl:w-[20%]  justify-end text-center">
          {id_auctionstarted !== "" ? (
            <button
            ...
            <button
              ...
              className="flex   text-center align-middle rounded-lg  font-bold hover:text-black"
            >
      ...
      <div className=" bg-white rounded-lg my-5 mx-5 h-full ">
            ...
            <div className="flex w-full  flex-col">
              <div className=" flex-col justify-center text-center items-center">
                ...
                <div className="flex justify-center mt-3 md:mt-5  ">
                  <select
                    className="flex w-full md:w-[70%] lg:w-[40%] xl:w-[40%] py-2 xl:py-1  border rounded-lg  text-center  bg-gray-200"
              ...
              <div className="w-full  flex md:mt-3  ">
                <div className="w-full mt-3 xl:mt-1 flex flex-col md:flex-row justify-center md:justify-start md:ms-3  align-middle items-center">
          ...
          {showModal && (
            ...
            >
              <div className="flex flex-col   justify-center items-center align-middle text-center">
                ...
                <div className="flex w-[30%] sm:w-[30%] md:w-[20%] lg:w-[10%]">
                  <button
              ...
              <div className="w-full mt-5  overflow-x-auto  max-h-72 flex-col justify-center  ">
                <div className=" w-full flex justify-center items-center align-middle ">
                  <table className="w-full lg:w-[60%] border rounded-lg border-gray-300 shadow-lg bg-white p-5   ">
            ...
            <div className="flex w-full flex-col lg:flex-row">
              <div className="w-full lg:w-1/2 order-1  ">
                <div className="flex flex-col w-full ">
                  <div className="flex flex-row mt-10 ms-2 sm:ms-14 lg:ms-10 xl:mt-5 ">
              ...
              <div className=" w-full lg:w-1/2 ms-3 sm:ms-0 ">
                <div className="flex-col  w-full  justify-center items-center">
                  <div className="w-full flex-col  justify-center">
                    <div className=" flex flex-col lg:flex-row lg:mt-3 xl:mt-0 lg:justify-center">
                      <div className="flex justify-center items-center align-middle mt-3 lg:mt-0   ">
                        <input
                          type="text"
                          placeholder="ใส่ชื่อที่ต้องการค้นหา"
                          className="flex w-[80%] sm:w-[60%] md:w-[50%] lg:w-[90%] border rounded-lg bg-gray-200 text-center sm:mt-5 md:mt-5 lg:mt-0 lg:py-2 px-2 py-1 md:py-2 leading-tight text-gray-700  shadow-md appearance-none focus:outline-none focus:shadow-outline"
                          value={searchText}
                          onChange={(e) => setSearchText(e.target.value)}
                        />
                      </div>

                      <div className="flex mt-3  justify-center lg:justify-start  w-full lg:w-[30%] xl:w-[25%]">
                        <button
                          className=" hover:bg-blue-300 hover:text-black w-[110px] lg:w-full py-2  ms-2   mt-3 lg:mt-0 lg:ms-0 lg:mb-2 xl:mb-0 text-sm  md:ms-7  text-sky-500 font-semibold  bg-sky-300 active:bg-sky-300 active:text-white  bg-opacity-30  rounded-lg focus:outline-none focus:shadow-outline"
                      ...
                      {showModal3 && (
                        ...
                        >
                          <div className="flex flex-col   justify-center items-center align-middle text-center">
                            ...
                            <input
                              type="text"
                              className=" w-[70%] sm:w-[40%]  lg:w-[40%] xl:w-[30%]  border rounded-lg bg-gray-100 mt-3  px-2 py-1 leading-tight text-gray-700  shadow-md appearance-none focus:outline-none focus:shadow-outline"
                              value={inputName}
                    ...
                    <div className="w-full mt-5  overflow-x-auto  max-h-96 sm:max-h-96  md:max-h-72 lg:max-h-72 flex-col rounded-lg justify-center ">
                      <div className=" w-full flex justify-center items-center align-middle">
                            ...
                            {filteredCustomerList.length === 0 ? (
                              ...
                              filteredCustomerList.map((data, index) => (
                                <tr key={index} className="hover:bg-gray-100">
                                  ...
                                  <td className="whitespace-no-wrap border-b border-gray-200 text-center text-xl">
                                    <button
                                      className=" bg-gray-400 active:bg-green-700 p-1 rounded hover:bg-green-700"
       ...
       แสดงรายชื่อผู้ร่วมประมูล :
          ...
          {/* <div className="w-full flex justify-center mb-5 space-x-5 xl:mb-3   "> */}
          {/* <div className="flex w-1/2 ">
              <button
                className=" hover:bg-amber-300 hover:text-black w-full text-sm font-semibold px-4 py-2 lg:mx-10 xl:mx-15 text-amber-500 bg-amber-300 bg-opacity-50 rounded-lg  focus:outline-none focus:shadow-outline"
          ...
          {/* <div className="flex w-1/2  ">
              <button
                onClick={handleEndAuction}
                className="w-full text-sm font-semibold px-4 py-2 lg:mx-10 xl:mx-15  text-red-500 bg-red-300 bg-opacity-50 rounded-lg hover:bg-red-300 hover:text-black  focus:outline-none focus:shadow-outline"
              >
                จบประมูล
              </button>
            </div> */}
